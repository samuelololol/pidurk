...
# libpurple/protocols/null/Makefile.  Generated from Makefile.in by configure.
...
am__objects_1 = nullprpl.lo
am_libnull_la_OBJECTS = $(am__objects_1)
libnull_la_OBJECTS = $(am_libnull_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
libnull_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
...
SOURCES = $(libnull_la_SOURCES)
DIST_SOURCES = $(libnull_la_SOURCES)
ETAGS = etags
CTAGS = ctags
DISTFILES = $(DIST_COMMON) $(DIST_SOURCES) $(TEXINFOS) $(EXTRA_DIST)
ACLOCAL = ${SHELL} /home/samuel/Development/pidgin-2.10.6/missing --run aclocal-1.11
ALLOCA = 
...
AR = ar
AUTOCONF = ${SHELL} /home/samuel/Development/pidgin-2.10.6/missing --run autoconf
AUTOHEADER = ${SHELL} /home/samuel/Development/pidgin-2.10.6/missing --run autoheader
AUTOMAKE = ${SHELL} /home/samuel/Development/pidgin-2.10.6/missing --run automake-1.11
...
EXEEXT = 
FARSTREAM_CFLAGS = -pthread -I/usr/include/gstreamer-0.10 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/libxml2  
FARSTREAM_LIBS = -pthread -lgstfarsight-0.10 -lgstbase-0.10 -lgstreamer-0.10 -lgobject-2.0 -lgmodule-2.0 -lxml2 -lgthread-2.0 -lrt -lglib-2.0  
FGREP = /bin/grep -F
GADU_CFLAGS = 
GADU_LIBS = 
...
GLIB_LIBS = -pthread -Wl,--export-dynamic -lgobject-2.0 -lgmodule-2.0 -lgthread-2.0 -lrt -lglib-2.0  
...
GREP = /bin/grep
GSTINTERFACES_CFLAGS = -pthread -I/usr/include/gstreamer-0.10 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/libxml2  
GSTINTERFACES_LIBS = -pthread -lgstinterfaces-0.10 -lgstreamer-0.10 -lgobject-2.0 -lgmodule-2.0 -lxml2 -lgthread-2.0 -lrt -lglib-2.0  
GSTREAMER_CFLAGS = -pthread -I/usr/include/gstreamer-0.10 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/libxml2  
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/samuel/Development/pidgin-2.10.6/missing --run makeinfo
MANIFEST_TOOL = :
MEANWHILE_CFLAGS = 
MEANWHILE_LIBS = 
MKDIR_P = /bin/mkdir -p
...
NSS_LIBS = -lssl3 -lsmime3 -lnssutil3 -lnss3 -lplds4 -lplc4 -lnspr4  
OBJDUMP = objdump
OBJEXT = o
OTOOL = 
OTOOL64 = 
...
PATH_SEPARATOR = :
PERL = perl
PERL_CFLAGS =  -fno-strict-aliasing -pipe -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -I/usr/lib64/perl5/5.12.4/x86_64-linux/CORE 
PERL_LIBS = -Wl,-E -Wl,-O1 -Wl,--as-needed -L/usr/lib64/perl5/5.12.4/x86_64-linux/CORE -lperl -lnsl -ldl -lm -lcrypt -lutil -lc
...
STATIC_PRPLS = 
STRIP = strip
TCL_CFLAGS = -I/usr/include -I/usr/include -fno-strict-aliasing
TCL_LIBS = -L/usr/lib64 -ltcl8.5
TK_LIBS = -L/usr/lib64 -ltk8.5
USE_NLS = yes
VERSION = 2.10.6
X11_CFLAGS = 
X11_LIBS = 
...
ZEPHYR_LDFLAGS = 
ZEPHYR_LIBS = 
abs_builddir = /home/samuel/Development/pidgin-2.10.6/libpurple/protocols/null
abs_srcdir = /home/samuel/Development/pidgin-2.10.6/libpurple/protocols/null
abs_top_builddir = /home/samuel/Development/pidgin-2.10.6
abs_top_srcdir = /home/samuel/Development/pidgin-2.10.6
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/samuel/Development/pidgin-2.10.6/install-sh
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am  $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --gnu libpurple/protocols/null/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --gnu libpurple/protocols/null/Makefile
.PRECIOUS: Makefile
...
libnull.la: $(libnull_la_OBJECTS) $(libnull_la_DEPENDENCIES) $(EXTRA_libnull_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(libnull_la_LINK) -rpath $(pkgdir) $(libnull_la_OBJECTS) $(libnull_la_LIBADD) $(LIBS)
